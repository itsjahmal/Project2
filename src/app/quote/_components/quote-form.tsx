...
function SubmitButton() {
  ...
  return (
    <Button type="submit" className="w-full transition-all duration-300 hover:scale-105" disabled={pending}>
...
export function QuoteForm() {
  ...
  const serviceType = searchParams.get('service') === 'cleaning' ? 'Cleaning' : 'Moving';
    ...
    <form action={formAction} className="space-y-6">
        <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="moving">Courier/Moving</Label>
            </div>
            <div className="flex items-center space-x-2">
