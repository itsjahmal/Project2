...
import { ArrowRight, CheckCircle, Package, Star, Users, Building } from 'lucide-react';
    ...
    <>
      <section className="bg-primary text-primary-foreground py-16 md:py-24">
        <div className="container mx-auto px-4 text-center md:px-6">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">Your Trusted Local Movers in Atlanta, GA</h1>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Our 5-Step Local Moving Process</h2>
       ...
       <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Comprehensive Moving Solutions</h2>
             <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
