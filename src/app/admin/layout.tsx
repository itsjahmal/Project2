...
const navItems = [
    ...
    { href: '/admin/quotes', icon: ShoppingCart, label: 'Quotes', badge: '6' },
    { href: '/admin/scheduling', icon: Calendar, label: 'Scheduling' },
    { href: '/admin/employees', icon: Users, label: 'Employees' },
    { href: '/admin/courier', icon: Truck, label: 'Courier Ops' },
...
function MobileNavLink({ item }: { item: typeof navItems[0] }) {
    const pathname = usePathname();
    const isActive = pathname === item.href;
    return (
        <Link
        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
            <Link href="/" className="flex items-center gap-2 font-semibold">
              ...
              <span className="">MoeMoe Admin</span>
            </Link>
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="flex flex-col">
              <nav className="grid gap-2 text-lg font-medium">
                ...
                >
                  <Package2 className="h-6 w-6" />
                  <span className="sr-only">MoeMoe Admin</span>
                </Link>
